      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/40 bg-emerald-950/60 px-3.5 py-1.5 text-xs font-semibold text-emerald-300">
            ...
            <span>Illustrative sustainability lens</span>
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            See the sustainability story behind better fit decisions
          </h2>
          <p className="text-sm text-slate-300">
            This illustrative calculator shows how a brand could add sustainability context to a clearer fit experience. Actual impact should be measured from your own order and return data.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 md:p-8 backdrop-blur-2xl shadow-2xl max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-800">
            <div className="flex items-center gap-3 text-center sm:text-left">
              ...
              <div>
                <p className="text-xs font-bold text-white">Add sustainability context to fit guidance</p>
                <p className="text-[11px] text-slate-400">Use your own order and return data to understand the impact.</p>
              </div>
            </div>
